...
set_post_thumbnail_size( 320, 320, true ); // Normal post thumbnails
 ...
 * @return void
 */
function cody_post_meta() {
  if ( get_post_type() == 'post' ) {
    echo sprintf(
      __( '<span class="post-date">%s</span> <span class="post-category">%s</span> <span class="post-author">by %s</span> ', 'site5framework' ),
